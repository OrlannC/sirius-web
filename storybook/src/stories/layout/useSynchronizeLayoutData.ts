...
import { useMultiToast, type GQLErrorPayload, type GQLSuccessPayload } from '@eclipse-sirius/sirius-components-core';
import { DiagramContext, type DiagramContextValue, type GQLHandleLayoutData, type GQLNodeLayoutData, type NodeData } from '@eclipse-sirius/sirius-components-diagrams';
import { type Node, Position } from '@xyflow/react';
import { useContext, useEffect } from 'react';
import { useTranslation } from 'react-i18next';
import type { GQLDiagramLayoutData, GQLEdgeLayoutData, GQLLabelLayoutData, GQLLayoutDiagramData, GQLLayoutDiagramInput, GQLLayoutDiagramPayload, GQLLayoutDiagramVariables, UseSynchronizeLayoutDataValue } from './useSynchronizeLayoutData.types';
import type { RawDiagram } from '@eclipse-sirius/sirius-components-diagrams/renderer/layout/layout.types';
import { isEdgeAnchorNode, type EdgeAnchorNodeData } from './EdgeAnchorNode.types';
import type { EdgeLabel } from '@eclipse-sirius/sirius-components-diagrams/renderer/DiagramRenderer.types';
