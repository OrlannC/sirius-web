...
import { useLabelMove } from './useLabelMove';
import { useLabelResize } from './useLabelResize';
import 'react-resizable/css/styles.css';
import { DiagramContext, Label, type DiagramContextValue } from '@eclipse-sirius/sirius-components-diagrams/index';
import type { OutsideLabel } from '@eclipse-sirius/sirius-components-diagrams/renderer/DiagramRenderer.types';
import type { DraggableResizableOutsideLabelProps, LabelSize } from './DraggableResizableOutsideLabel.types';
...
export const DraggableResizableOutsideLabel = ({
  ...
  const onDragStop = (_e: any, eventData: DraggableData) => {
      ...
      <Draggable
        ...
        <div ref={nodeRef} style={resizableLabelStyle(theme, size, label, selected || hovered)}>
          <Resizable
            ...
            handle={(handleAxis, ref) => <CustomResizeHandle innerRef={ref} handleAxis={handleAxis} onMouseDown={undefined} onMouseUp={undefined} />}>
...
const CustomResizeHandle = (props: { innerRef: React.Ref<HTMLDivElement> | undefined; handleAxis: any; onMouseDown: React.MouseEventHandler<HTMLDivElement> | undefined; onMouseUp: React.MouseEventHandler<HTMLDivElement> | undefined; }) => {
  return (
    <div
      ref={props.innerRef}
