...
import { type DiagramDescriptionContextValue } from './DiagramDescriptionContext.types';
import { type UseDiagramDescriptionValue } from './useDiagramDescription.types';
