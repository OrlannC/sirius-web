 ...
 *******************************************************************************/
import { type Edge, Handle, type Node, type NodeProps, Position, type ReactFlowState, useReactFlow, useStore } from '@xyflow/react';
import { memo, useEffect } from 'react';

import { type EdgeAnchorNodeData } from './EdgeAnchorNode.types';
import { type NodeComponentsMap } from './NodeTypes';
import { useRefreshConnectionHandles, type EdgeData, type NodeData } from '@eclipse-sirius/sirius-components-diagrams';
import { getHandlePositionFromNodeAndPath } from './EdgeLayout';
