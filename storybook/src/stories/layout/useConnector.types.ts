...
import type { GQLTool } from '@eclipse-sirius/sirius-components-diagrams/renderer/palette/Palette.types';
import { type Connection, type OnConnect, type OnConnectEnd, type OnConnectStart, type XYPosition } from '@xyflow/react';
